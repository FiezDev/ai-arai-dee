...
export const lessons = [
  ...
  },
  {
    ...
    iterations: [
      ...
      { n: 2, delta: t('lesson.slides.iter.2.delta'), prompt: t('lesson.slides.iter.2.prompt'), img: 'docker-guide-page1.jpg', cap: t('lesson.slides.iter.2.cap') },
  ...
  },
  {
    ...
    iterations: [
      { n: 1, delta: t('lesson.web.iter.1.delta'), prompt: t('lesson.web.iter.1.prompt'), img: 'araid-design.jpg', cap: t('lesson.web.iter.1.cap') },
      { n: 2, delta: t('lesson.web.iter.2.delta'), prompt: t('lesson.web.iter.2.prompt'), img: 'hero-poster.jpg', cap: t('lesson.web.iter.2.cap') },
      { n: 3, delta: t('lesson.web.iter.3.delta'), prompt: t('lesson.web.iter.3.prompt'), img: 'araid-desktop_s1_hero.jpg', cap: t('lesson.web.iter.3.cap') },
      { n: 4, delta: t('lesson.web.iter.4.delta'), prompt: t('lesson.web.iter.4.prompt'), img: 'araid-desktop_full.jpg', cap: t('lesson.web.iter.4.cap') },
      { n: 5, delta: t('lesson.web.iter.5.delta'), prompt: t('lesson.web.iter.5.prompt'), img: 'araid-mobile_hero.jpg', cap: t('lesson.web.iter.5.cap') },
    ],
    prompt1: '',
    prompt2: '',
